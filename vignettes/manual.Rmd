...
remotes::install_github("selkamand/chemviewR", dependencies = TRUE)
```
...
plot_molecule(benzene, clear_scene = FALSE, widget = FALSE); next3d()
text3d(0,0,0,"Caffeine"); next3d()
plot_molecule(caffeine, clear_scene = FALSE, widget = FALSE); next3d()
text3d(0,0,0,"Sunflower"); next3d()
plot_molecule(sunflower, clear_scene = FALSE, widget = FALSE); next3d()
text3d(0,0,0,"Iron tripod"); next3d()
plot_molecule(fe_tripod, clear_scene = FALSE, widget = FALSE); next3d()
text3d(0,0,0,"Aspirin"); next3d()
plot_molecule(aspirin, clear_scene = FALSE, widget = FALSE); next3d()
text3d(0,0,0,"Basketine"); next3d()
plot_molecule(basketine, clear_scene = FALSE, widget = FALSE); next3d()
text3d(0,0,0,"Cubane"); next3d()
plot_molecule(cubane, clear_scene = FALSE, widget = FALSE); next3d()
text3d(0,0,0,"Fullerene"); next3d()
plot_molecule(fullerene, clear_scene = FALSE, widget = FALSE);
rglwidget()
```
...
fe_tripod <- fe_tripod |>
  add_symmetry_element_to_molecule(
    ProperRotationAxis(n = 3, posA = posA, posB = posB, label = "Iron Tripod C3")  
  )
...
benzene_file = system.file(package = "chemviewR", "benzene.mol2"); 
benzene <- read_mol2(benzene_file); 
benzene <- add_symmetry_element_to_molecule(benzene, ProperRotationAxis(posA = c(0, 0, 0), posB = c(0, 0, 1), n = 6))

plot_molecule(benzene)
```
